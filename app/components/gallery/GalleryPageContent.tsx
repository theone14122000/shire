...
export function GalleryPageContent() {
  ...
  return (
    <section className="relative isolate overflow-hidden" style={{ backgroundColor: DEEP }}>
      {/* Ambient depth */}
      <div aria-hidden className="pointer-events-none absolute inset-0" style={{
        background: `radial-gradient(60% 45% at 15% 0%, rgba(52,211,153,0.20) 0%, transparent 60%), radial-gradient(55% 45% at 95% 15%, rgba(52,211,153,0.12) 0%, transparent 55%)`,
      }} />
          ...
          <div className="grid grid-cols-2 divide-x divide-y divide-white/10 sm:grid-cols-4 sm:divide-y-0">
            {STATS.map((stat, i) => (
              ...
              >
                ...
                <span className="text-[9px] font-bold uppercase tracking-[0.14em] text-white/50 sm:text-[10px] sm:tracking-[0.16em]">
                  {stat.label}
                </span>
              </div>
            ))}
      ...
      <section className="relative overflow-hidden py-16 sm:py-20 lg:py-24">
        <span aria-hidden className="pointer-events-none absolute -right-10 top-6 select-none font-display text-[15vw] font-black uppercase leading-none tracking-tighter text-white/[0.03]">
          Spaces
        </span>
        <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          ...
          >
            <span className="text-[11px] font-bold uppercase tracking-[0.22em]" style={{ color: "#34d399" }}>
              Browse By Space
            </span>
            <h2 className="font-display text-2xl font-black tracking-tight text-white sm:text-4xl">
              Every Corner, <span style={{ color: "#34d399" }}>Captured</span>
            </h2>
          </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0" style={{
                    background: `linear-gradient(to top, ${DEEP}e6 10%, ${DEEP}33 55%, transparent 80%)`,
                  }} />
                  <div className="absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full backdrop-blur-md sm:h-9 sm:w-9"
                    style={{ backgroundColor: `${DEEP}99`, color: "#34d399" }}>
                  ...
                  <div className="absolute inset-x-0 bottom-0 flex flex-col items-start gap-0.5 p-3.5 text-left sm:p-4">
                    <span className="rounded-full px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider sm:text-[10px]"
                      style={{ backgroundColor: "#34d399", color: DEEP }}>
      ...
      <section id="collection" className="relative scroll-mt-24 overflow-hidden pb-16 sm:pb-20 lg:pb-24">
        <span aria-hidden className="pointer-events-none absolute -left-10 top-0 select-none font-display text-[15vw] font-black uppercase leading-none tracking-tighter text-white/[0.03]">
          Collection
        </span>
        <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <motion.div
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  {!active && (
                    <span className="absolute inset-0 -z-10 rounded-full border"
      ...
      {/*  CTA                                                            */}
      {/* ══════════════════════════════════════════════════════════════ */}
      <section className="border-t border-white/10 pb-20 sm:pb-24 lg:pb-28">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.5 }}
            transition={{ duration: 0.6 }}
            className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] p-8 text-center shadow-lg backdrop-blur-md sm:p-10"
          >
            <span aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-[2px]" style={{ backgroundColor: "#34d399" }} />
            ...
            <a
              ...
              style={{ backgroundColor: "#34d399", color: DEEP, boxShadow: "0 10px 30px rgba(52,211,153,0.4)" }}
            >
              Book Your Stay
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{ borderColor: "#34d39933", backgroundColor: `${DEEP}b3`, color: "#34d399" }}
              >
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
            <span className="flex h-9 w-9 items-center justify-center rounded-full backdrop-blur-md sm:h-10 sm:w-10"
              style={{ backgroundColor: "#34d399e6", color: DEEP }}>
          ...
          <div className="absolute left-2 top-2 flex items-center gap-1.5 sm:left-3 sm:top-3">
            {isFeatured && (
              <span className="inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider backdrop-blur-md sm:text-[10px]"
                style={{ backgroundColor: "#34d399", color: DEEP }}>
            ...
            <span className="rounded-full px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider backdrop-blur-md sm:text-[10px]"
              style={{ backgroundColor: `${DEEP}99`, color: "#34d399" }}>
              {item.category}
            </span>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 translate-y-3 p-2.5 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 sm:p-3.5">
            <span className="inline-block max-w-full truncate rounded-full px-3 py-1 text-[9px] font-bold shadow-sm sm:px-3.5 sm:py-1.5 sm:text-[11px]"
              style={{ backgroundColor: "#34d399", color: DEEP }}>
              {item.title}
            </span>
          </div>
