...
/**
 * FloatingActions — the two corner action buttons from the original
 * site (Call + WhatsApp), rendered as fixed bottom-corner pills.
 */
    ...
    <div className="fixed inset-x-0 bottom-4 z-40 pointer-events-none">
      <div className="container-luxe flex items-end justify-between pointer-events-none">
        <motion.a
          ...
          className="pointer-events-auto inline-flex items-center justify-center h-12 w-12 sm:h-14 sm:w-14 rounded-full bg-accent-emerald text-beige-100 shadow-[var(--shadow-lift)] transition-transform duration-300 hover:scale-110"
        ...
        <motion.a
          ...
          className="pointer-events-auto inline-flex items-center justify-center h-12 w-12 sm:h-14 sm:w-14 rounded-full bg-[#25D366] text-beige-100 shadow-[var(--shadow-lift)] transition-transform duration-300 hover:scale-110"
