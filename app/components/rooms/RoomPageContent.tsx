        ...
        >
          ...
          >
            <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-amber-300/40 bg-emerald-900/30 px-4 py-1.5 text-[11px] font-bold uppercase tracking-[0.2em] text-amber-300 backdrop-blur-sm">
              ...
              {titleWords.map((word, i) => {
                ...
                return (
                  <motion.span
                    key={`${word}-${i}`}
                    variants={wordUp}
                    className={`mr-[0.25em] inline-block ${isLast ? "text-amber-400" : ""}`}
                  >
                    {word}
                  </motion.span>
                );
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              >
                {specs.map((spec) => (
                  ...
                  >
                    <span className="absolute inset-x-0 bottom-0 mx-auto h-[3px] w-0 rounded-full bg-amber-400 transition-all duration-500 group-hover:w-2/3" />
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <h2 className="font-display text-3xl font-black tracking-tight text-white sm:text-4xl">
                  Amenities &amp; <span className="text-amber-400">Comforts</span>
                </h2>
              </motion.div>
          ...
          <section id="gallery" className="relative scroll-mt-24 overflow-hidden pb-16 sm:pb-20 lg:pb-24">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="border-l-4 border-amber-400 pl-5">
                  ...
                  <h2 className="mt-1 font-display text-3xl font-black tracking-tight text-white sm:text-4xl">
                    Visual Tour <span className="text-amber-400">Gallery</span>
                  </h2>
                </div>
              </motion.div>
                    ...
                    >
                      <div className="relative h-full w-full overflow-hidden rounded-[1.25rem] bg-emerald-900/40">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 translate-y-4 p-3.5 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
                          <span className="inline-block truncate rounded-full bg-amber-400 px-3.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-emerald-950 shadow-sm">
                            {label}
                          </span>
                        </div>
                        <div className="absolute right-3 top-3 flex items-center gap-1.5 rounded-full bg-emerald-950/60 px-2.5 py-1 text-[10px] font-bold text-amber-300 backdrop-blur-md">
              ...
              >
                <span
                  aria-hidden
                  className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-amber-400"
                />
