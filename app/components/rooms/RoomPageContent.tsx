  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-amber-300/25 bg-emerald-950/40 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.16em] text-amber-200 backdrop-blur-md">
            <motion.span
        ...
        >
          <Link
            href="/#rooms"
            className="group inline-flex items-center gap-2 rounded-full border border-emerald-300/20 bg-emerald-950/40 px-4 py-2 text-xs font-bold text-amber-200/80 backdrop-blur-md transition-colors hover:border-amber-300/50 hover:bg-emerald-900/60 hover:text-amber-100"
          >
        ...
        >
          ...
          >
            <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-amber-300/40 bg-emerald-950/30 px-4 py-1.5 text-[11px] font-bold uppercase tracking-[0.2em] text-amber-200 backdrop-blur-sm">
            ...
            <motion.p
              variants={fadeUp}
              className="max-w-2xl text-sm leading-relaxed text-amber-100/70 sm:text-base lg:text-lg"
            >
              {room.description}
            </motion.p>
            ...
            <motion.div variants={fadeUp} className="mt-2 flex flex-wrap items-center gap-4">
              <a
                href="#book"
                className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-amber-400 px-7 py-3.5 text-sm font-bold text-emerald-950 shadow-[0_10px_30px_rgba(251,191,36,0.4)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-amber-300"
              >
              ...
              <a
                href="#gallery"
                className="inline-flex items-center gap-2 rounded-full border-2 border-amber-300/40 bg-emerald-950/20 px-7 py-3.5 text-sm font-bold text-amber-200 backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-300/60 hover:bg-emerald-900/40 hover:text-amber-100"
              >
                View Gallery
              </a>
            </motion.div>
      ...
      {/* ======================== */}
      {/* SPECS STRIP — Solid Emerald + Yellow Text */}
      {/* ======================== */}
      <section className="relative bg-emerald-900 py-14 sm:py-18 lg:py-22">
          ...
          >
            {specs.map((spec, idx) => (
              <motion.div
                key={spec.label}
                variants={fadeUp}
                className={`group relative flex flex-col items-center gap-3 py-8 text-center transition-all duration-500 hover:bg-emerald-800/50 sm:px-6 ${
                  idx !== 0 ? "sm:border-l sm:border-amber-400/20" : ""
                }`}
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-full border border-amber-400/40 bg-amber-400/10 text-amber-400 transition-all duration-300 group-hover:scale-110 group-hover:border-amber-300 group-hover:bg-amber-400/20">
                  <SpecIcon name={spec.icon} />
                </span>
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-amber-400/70 sm:text-[11px]">
                  {spec.label}
                </span>
                <span className="font-display text-xl font-black text-amber-300 sm:text-2xl">
                  {spec.value}
                </span>
                
                <span className="absolute bottom-0 left-1/2 h-[2px] w-0 -translate-x-1/2 rounded-full bg-amber-400 transition-all duration-500 group-hover:w-16" />
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="relative overflow-hidden bg-emerald-50/60 py-16 sm:py-20 lg:py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="font-display text-3xl font-black tracking-tight text-emerald-950 sm:text-4xl">
              Amenities &amp; Comforts
            </h2>
          </motion.div>
          ...
          >
            {room.facilities.map((facility) => (
              ...
              >
                <span className="absolute left-0 top-0 h-full w-1 bg-emerald-500 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-700 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M20 6L9 17l-5-5" />
                  </svg>
                </span>
                <span className="text-sm font-bold text-emerald-950">{facility}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="border-l-4 border-amber-400 pl-5">
              ...
              <h2 className="mt-1 font-display text-3xl font-black tracking-tight text-emerald-950 sm:text-4xl">
                Visual Tour Gallery
              </h2>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-emerald-950">Want the full experience?</p>
              ...
              <a
                href="#brochure"
                className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-6 py-3 text-xs font-bold text-emerald-900 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-300 hover:bg-amber-50"
              >
                Download Brochure
