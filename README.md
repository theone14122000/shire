...
See [docs/seo-report.md](docs/seo-report.md), [docs/tags-and-metadata.md](docs/tags-and-metadata.md), [docs/structured-data.md](docs/structured-data.md), and [docs/page-seo-keywords.md](docs/page-seo-keywords.md).

### LLMs.txt

- A machine-readable summary for AI tools at `/llms.txt`.
- See [docs/llms-txt.md](docs/llms-txt.md).
